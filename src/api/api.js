...
export const BASE_URL = 'https://api.gammabiotechs.com'

// https://cross-api.scotttiger.in
...
export const ReferalApi = new APIBase({
    baseURL: `${BASE_URL}/api/referral/`,
});

export const registerPartnerApi = new APIBase({
    baseURL: `${BASE_URL}/api/register-as-partner/`,
});

export const DemoApi = new APIBase({
    baseURL: `${BASE_URL}/api/book-demo/`,
});
...
export const industriesApi = new APIBase({
    baseURL: `${BASE_URL}/api/industry/`,
});

export const industryFeatureApi = new APIBase({
    baseURL: `${BASE_URL}/api/industry-feature/`,
});
